...
import 'package:praktikum_section_20/model/add_contact_list.dart';
import 'package:praktikum_section_20/provider/added_contact.dart' as contacts;
            ...
            ElevatedButton(
                onPressed: () {
                  ...
                  if (nama.isNotEmpty && number != 0) {
                    nameController.text = '';
                    numberController.text = '';
                    contactProvider.update(indexTerpilih, nama, number);
                    indexTerpilih = -1;
                  }
                },
                style: ButtonStyle(
  ...
  Widget getList(int index) {
    ...
    return ListTile(
        leading: CircleAvatar(
          ...
          child: Text(
            contactProvider.contacts[index].nama[0].toUpperCase(),
        ...
        title: Column(
          ...
          children: [
            ...
            Text(contactProvider.contacts[index].number.toString()),
            Text(
                'Date Added : ${contactProvider.contacts[index].date?.day}-${contactProvider.contacts[index].date?.month}-${contactProvider.contacts[index].date?.year}'),
            Row(
              children: [
                const Text('Color : '),
        ...
        trailing: SizedBox(
          ...
          child: Row(
            children: [
              IconButton(
                  onPressed: () {
                    nameController.text = contactProvider.contacts[index].nama;
                    numberController.text =
                        contactProvider.contacts[index].number.toString();
